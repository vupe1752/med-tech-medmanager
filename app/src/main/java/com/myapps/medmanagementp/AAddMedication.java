...
public class AAddMedication extends AppCompatActivity implements SelectDateDialog.SelectDateDialogListener,
        SelectDateDialogB.SelectDateDialogBListener {

    EditText dose1, instruction1, note1, providerName1, startDateText1, endDateText1;
    TextView testText, btnMed1;
    Button setReminder1, startDate1, endDate1, btnSave1, btnCancel1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MainActivity.med_naMe != null) {med_naMe1 = MainActivity.med_naMe;}

        else if (CameraActivity.name != null) {
            med_naMe1 = CameraActivity.name;}
        ...
        btnCancel1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btnMed1.setText("");
                med_naMe1 = null;
                MainActivity.med_naMe = null;
                CameraActivity.name = null;
        ...
        btnSave1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WDbHelper.updateMed(med_naMe1, dose,instruction,note,provider);
